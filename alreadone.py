...
async def help(ctx, commandSent=None):
          ...
          embed.add_field(name="t!invites", value="-Shows amount of invited people by you, or someone else.", inline=True)
          embed.add_field(name="t!ping", value="Shows ping of the bot")
